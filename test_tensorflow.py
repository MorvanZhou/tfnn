...
network.set_learning_rate(lr=0.01, exp_decay=dict(decay_steps=100, decay_rate=0.9, staircase=False))

evaluator = tfnn.Evaluator(network)
# evaluator.set_line_fitting_monitor()
# evaluator.set_data_fitting_monitor()
# evaluator.set_scale_monitor(['cost', 'r2', 'learning rate', 'dropout'], figsize=(7, 7))
...
for i in range(2000):
    ...
    if i % 100 == 0:
        ...
        # summarizer.record_train(b_xs, b_ys, keep_prob=0.5,)
