...
class Normalizer(object):
    ...
    def minmax_fit(self, data, lower_bound=-1, upper_bound=1, inplace=False):
    ...
    def std_fit(self, data, mean=0, std=1, inplace=False):
    ...
    def mean_fit(self, data, inplace=False):
        xs_mean = np.mean(data.xs, axis=0)
